...
export interface ApiBannerBanner extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    banner_backgroundColor: Schema.Attribute.String;
    banner_description: Schema.Attribute.String;
    banner_TextColor: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiHighlightHighlight extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    tile1_description: Schema.Attribute.String;
    tile1_heading: Schema.Attribute.String;
    tile2_description: Schema.Attribute.String;
    tile2_heading: Schema.Attribute.String;
    tile3_description: Schema.Attribute.String;
    tile3_heading: Schema.Attribute.String;
    tile4_description: Schema.Attribute.String;
    tile4_heading: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    product_images: Schema.Attribute.Media<
      ...
      true
    >;
    product_isAvailable: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
    product_isFeatured: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    product_name: Schema.Attribute.String;
    product_price: Schema.Attribute.String;
    product_videos_YoutubeIDs: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
